...
class CentroidUpdater:
    ...
    def reset(self):
        ...
        self.feature_sum_p = torch.zeros(self.num_parts, self.num_classes, self.feature_size, device=self.device)
        self.feature_count_p = torch.zeros(self.num_parts, self.num_classes, device=self.device)
...
#         self.centroids_p = torch.zeros(num_parts, num_classes, feature_size,device=device)
...
#         self.feature_sum_p = torch.zeros(num_parts, num_classes, feature_size,device=device)
#         self.feature_count_p = torch.zeros(num_parts, num_classes,device=device)
